...
#define VERSION_H
	...
	static const long BUILDS_COUNT = 503;
	#define RC_FILEVERSION 1,3,368,2079
	#define RC_FILEVERSION_STRING "1, 3, 368, 2079\0"
	static const char FULLVERSION_STRING[] = "1.3.368.2079";
